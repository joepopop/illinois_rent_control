...
Lift the Ban Coalition argues that the threshold of 6 properties owned should be used to divide "big" vs "small" landlords, while 12 is the standard number recognized in the discussion. However, no matter the choice, the percentage of "small" landlords is nearly 100%. This finding motivates an investigation of the prevalence of properties owned by "small" landlords in different community areas.
...
All in all, the opposition's claim that there are many "mom and pop" landlords that can be harmed through rent control appears strong, but a close examination of individual community areas argues otherwise.  Even though most Illinois Cook landlords are "mom and pop" landlords, properties owned by them account for less than 50% of the total in the populous areas around Chicago: Oakland (30%), Near South Side (39%), and Loop (49%).  This finding will serve directly in crafting legislation that would advocate for rent control in community areas with a high population and low percentage of "small" landlord properties.
